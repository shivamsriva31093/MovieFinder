 ...
 * <p/>
 * Once the data queries are loaded in the Model, the {@link Presenter} updates the View by
 * calling {@link #displayData(Object, QueryEnum)} or {@link #displayErrorMessage(QueryEnum)} so the
 * View can redraw itself with the updated data.
 * <p/>
 ...
 * user performs an action on the View. After the data is updated, the {@link Presenter}
 * updates the View by calling {@link #displayUserActionResult(Object, UserActionEnum,
 * boolean)}.
 * <p/>
 * The View belongs to an {@link android.app.Activity} that typically has been started with
